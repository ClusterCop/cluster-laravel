...
Route::resource('specialrate', 'Resource\SpecialrateResource');
...
Route::group(['as' => 'provider.'], function () {
    ...
    Route::post('provider/{provider}/service', 'Resource\ProviderDocumentResource@service_update')->name('document.service.update');
    Route::delete('provider/{provider}/service/{document}', 'Resource\ProviderDocumentResource@service_destroy')->name('document.service.delete');
});
...
Route::resource('adminrequest', 'Resource\AdminRequestResource');
Route::group(['as' => 'adminrequest.'], function () {
    Route::get('adminrequest/{id}/status', 'Resource\AdminRequestResource@status');
    Route::post('adminrequest/rate', 'Resource\AdminRequestResource@rate');
    Route::post('adminrequest/cancel/ride', 'Resource\AdminRequestResource@cancel_ride');
    //Route::post('adminrequest/payment', 'PaymentController@admin_payment');
});
Route::get('listprovider', 'Resource\AdminRequestResource@providers')->name('adminrequest.providers');
Route::get('confirm', 'Resource\AdminRequestResource@confirm_ride')->name('adminrequest.confirm');
Route::post('create-ride', 'Resource\AdminRequestResource@create_ride')->name('adminrequest.create_ride');
