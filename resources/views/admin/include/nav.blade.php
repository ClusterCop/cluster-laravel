<div class="site-sidebar">
	<div class="custom-scroll custom-scroll-light">
		<ul class="sidebar-menu">
			...
			<li class="menu-title">@lang('admin.include.multi_requests')</li>
			<li>
				<a href="{{ route('admin.adminrequest.providers') }}" class="waves-effect  waves-light">
			...
			<li class="with-sub">
				...
				<ul>
					<li><a href="{{ route('admin.adminrequest.create') }}">@lang('admin.include.add_ride')</a></li>
					<li><a href="{{ route('admin.adminrequest.index') }}">@lang('admin.include.list_rides')</a></li>
				</ul>
			</li>
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					<span class="s-caret"><i class="fa fa-angle-down"></i></span>
					<span class="s-icon"><i class="ti-layout-tab"></i></span>
					<span class="s-text">@lang('admin.include.specialrates')</span>
				</a>
				<ul>
					<li><a href="{{ route('admin.specialrate.index') }}">@lang('admin.include.list_specialrates')</a></li>
					<li><a href="{{ route('admin.specialrate.create') }}">
					@lang('admin.include.add_new_specialrate')</a></li>
				</ul>
			</li>
