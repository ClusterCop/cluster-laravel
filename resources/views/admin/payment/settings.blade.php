                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-8">
                                <select name="currency" class="form-control" required>
                                    <option @if(Setting::get('currency') == "COP") selected @endif value="COP">Colombian peso (COP)</option>
                                    <option @if(Setting::get('currency') == "ARS") selected @endif value="ARS">Argentina Peso (ARS)</option>
