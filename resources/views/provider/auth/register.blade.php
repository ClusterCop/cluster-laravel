...
@section('content')
<div class="col-md-12">
    <a class="log-blk-btn" href="{{ url('/provider/login') }}">¿Ya tienes una cuenta?</a>
    <h3>Regístrate</h3>
</div>
...
<div class="col-md-12">
    <form class="form-horizontal" role="form" method="POST" action="{{ url('/provider/register') }}">
        ...
        <div id="first_step">
            <div class="col-md-4">
                <input value="{{ env('APP_PHONE_PREFIX', '+91') }}" type="text" placeholder="{{ env('APP_PHONE_PREFIX', '+91') }}" id="country_code" name="country_code" />
            </div> 
            ...
            <div class="col-md-12" style="padding-bottom: 10px;" id="mobile_verfication">
                <input type="button" class="log-teal-btn small" onclick="smsLogin();" value="Verifica tu número de teléfono"/>
            </div>
        </div>
